...
public abstract class AxisBoxBuilder {
    ...
    private AxisBoxPainter  _axisBoxPainter;
    ...
    public AxisBoxBuilder(DataArea aDataArea, Scene3D aScene)
    {
        ...
        _axisBoxPainter = new AxisBoxPainter(this, aDataArea, aScene);
    }

    /**
     * Returns the AxisBoxPainter to paint tick labels.
     */
    public AxisBoxPainter getAxisBoxPainter()  { return _axisBoxPainter; }
