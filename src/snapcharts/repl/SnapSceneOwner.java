...
public class SnapSceneOwner extends ViewOwner {
    ...
    {
        // Create Scene
        _scene = (SnapScene) super.createUI();
        if (!isShowControls()) return _scene;
        _scene.setAutoStart(false);

        // Configure ScrollView to hold scene
        ScrollView sview = new ScrollView(_scene);
        ...
        bview.setBottom(_toolBar.getUI());
